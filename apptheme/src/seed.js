  ...
  const products = [
    {
      ...
      price: 1290000, salePrice: 890000, categoryIds: [1], frameworks: ['tailwind', 'html'],
      pages: 12, features: ['ریسپانسیو کامل', 'حالت تاریک', 'بهینه سئو', 'سرعت ۹۸+ گوگل', 'پشتیبانی ۶ ماهه'],
    ...
    },
    {
      ...
      price: 990000, salePrice: null, categoryIds: [2], frameworks: ['bootstrap', 'html'],
      pages: 14, features: ['۱۴ صفحه آماده', 'فرم تماس داینامیک', 'ریسپانسیو', 'اسلایدر حرفه‌ای', 'مستندسازی کامل'],
    ...
    },
    {
      ...
      price: 690000, salePrice: 490000, categoryIds: [3], frameworks: ['react', 'tailwind'],
    ...
    },
    {
      ...
      price: 590000, salePrice: null, categoryIds: [4], frameworks: ['html', 'tailwind'],
      pages: 3, features: ['تک‌صفحه‌ای', 'تایمر عرضه', 'قیمت‌گذاری', 'FAQ آکاردئونی', 'سبک (< ۵۰KB)'],
    ...
    },
    {
      ...
      price: 790000, salePrice: 590000, categoryIds: [5], frameworks: ['bootstrap'],
      pages: 6, features: ['منوی دیجیتال', 'رزرو آنلاین', 'گالری تصاویر', 'نقشه گوگل', 'ریسپانسیو'],
    ...
    },
    {
      ...
      price: 1090000, salePrice: 850000, categoryIds: [6], frameworks: ['react', 'html'],
      pages: 10, features: ['فیلتر نمونه‌کار', 'آمار متحرک', 'وبلاگ', 'React 18', 'انیمیشن اسکرول'],
    ...
    },
    {
      ...
      price: 1150000, salePrice: null, categoryIds: [2], frameworks: ['bootstrap', 'tailwind'],
      pages: 9, features: ['درخواست نوبت', 'پروفایل پزشکان', 'مقالات سلامت', 'ریسپانسیو', 'سئو استاندارد'],
    ...
    },
    {
      ...
      price: 550000, salePrice: 390000, categoryIds: [3], frameworks: ['html'],
